...
public class Operation implements ActionListener
{
    ...
    public int framewidth = 333;
    public int frameheight = 470;
    public int displaywidth = framewidth-10;
    ...
    int historyfromtop = 160;
    int historyheight = 40;
    int historyfromside = 5;
    int historywidth = displaywidth;
    ...
    Color history_foreground_color;
    ...
    public Operation()
    {
        ...
        mediumFont = new Font("Arial",Font.PLAIN,30);
        ...
        history.setBounds(historyfromside,historyfromtop,historywidth,historyheight);
        history.setHorizontalAlignment(SwingConstants.LEFT);
        history.setOpaque(false);
        history.setBorder(null);
        history.setForeground(display_foreground);
        history.setFont(mediumFont);
    ...
    public void Light()
    {
        ...
        history_foreground_color = Color.BLACK;
    ...
    public void Dark()
    {
        ...
        history_foreground_color = Color.WHITE;
        //
    ...
    public void setValue()
    {
        ...
        display.setForeground(display_foreground);
        history.setForeground(history_foreground_color);
